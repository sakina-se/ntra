            ...
            <div class="container-fluid relative px-3">
                <div class="layout-specing">
                    ...
                    <div class="md:flex justify-between items-center">
                        <h5 class="text-lg font-semibold">Edit Ad</h5>
                    ...
                    <div class="container relative">
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                            ...
                            <div class="rounded-md shadow dark:shadow-gray-700 p-6 bg-white dark:bg-slate-900 h-fit">
                                <form id="ads-update" action="/ads/update/<?=$ad->id?>" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_method" value="patch">
                                    <div class="grid grid-cols-12 gap-5">
                                        <!-- Title -->
                                        <div class="col-span-12">
                                            <label for="title" class="font-medium">Title</label>
                                            <input name="title" id="title" type="text" class="form-input mt-2" value="<?= $ad[0]->title; ?>" >
                                        </div>
                                        ...
                                        <div class="md:col-span-4 col-span-12">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                ...
                                                <textarea name="desc" id="desc" class="form-input ps-11"><?= $ad[0]->description; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md:col-span-4 col-span-12">
                                            ...
                                            <input name="address" id="address" type="text" class="form-input mt-2" value="<?= $ad[0]->address; ?>">
                                        </div>
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                ...
                                                <input name="price" id="price" type="number" class="form-input ps-11" value="<?= $ad[0]->price; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <input name="rooms" id="rooms" type="number" class="form-input ps-11" value="<?= $ad[0]->rooms; ?>">
                                            </div>
                                        </div>
                                    </div>
